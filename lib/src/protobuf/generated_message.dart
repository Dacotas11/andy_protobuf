...
abstract class GeneratedMessage {
 ...
 // Map<String, dynamic> writeToJsonMap() => _writeToJsonMap(_fieldSet);
  // Map<String, dynamic> writeToJsonMapInsert() => _writeToJsonMapInsert(_fieldSet);
Map<String, dynamic> writeToJsonMap({bool useInserStm = false}) => _writeToJsonMap(_fieldSet,useInserStm :useInserStm);
