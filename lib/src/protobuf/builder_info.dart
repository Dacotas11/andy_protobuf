...
class BuilderInfo {
  ...
  String? fielProtodName(int tagNumber) {
    var i = fieldInfo[tagNumber];

    return i != null ? i.protoName : null;
  }

  String? getDetails(int tagNumber) {
    var i = fieldInfo[tagNumber];
    if (i != null) {
      int fieldType = i.type;
    var typeBase=  PbFieldType._baseType(fieldType);
